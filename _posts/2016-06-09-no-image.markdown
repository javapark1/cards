...
---
A test by PadoGrid. When there is no image mentioned in the front-matter, default image will be displayed. You can change this image to any other one that suits your needs. The theme uses the latest bootstrap 4 css framework. 
